      ...
      <section className="pt-10">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <label htmlFor="price">Number of sales</label>
              <input
                type="number"
                name="sold"
                step="1"
            ...
            <div>
              <label htmlFor="color">Brand name</label>
              <input
                type="text"
                name="brand"
                required
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                defaultValue={
                  product ? product.features.details.category : "Others"
                }
              >
            ...
            <div className="flex gap-10">
              <div>
                <p className="mb-2">Home delivery</p>
